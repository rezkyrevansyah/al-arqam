  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => navigate('/artikel/baru')}
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <button onClick={() => navigate(`/artikel/edit/${a.id}`)} className="p-1.5 hover:bg-gray-100 rounded-lg"><Pencil className="w-3.5 h-3.5 text-gray-400" /></button>
